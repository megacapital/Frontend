      ...
      <Grid>
        <Grid paddingLeft={'7%'} paddingRight={'7%'}>
          <Grid align="center" justifyContent="center">
            ...
            <a href="#" className="btn btn-dark text-info mx-1">
              Staking Pools
            </a>
            <a href="/farmingpool" className="btn btn-light text-info mx-1">
              Farming Pools
            </a>
          </Grid>
  ...
  return (
    <Card>
      <CardContent>
        ...
        <Typography variant="body2">Allocations X1</Typography>
        <Button size="small" sx={{ bgcolor: 'grey' }}>
          FCFS
        </Button>
